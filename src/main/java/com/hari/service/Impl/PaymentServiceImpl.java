...
import com.hari.domain.PaymentOrderStatus;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentOrder getPaymentOrderById(Long orderId) throws Exception {
        return paymentOrderRepository.findById(orderId).orElseThrow(()->new Exception("order not found with id :"+orderId));
    }
                ...
                .addLineItem(SessionCreateParams.LineItem.builder()
                        ...
                        .setPriceData(SessionCreateParams.LineItem.PriceData.builder()
                                ...
                                .setProductData(SessionCreateParams
                                        .LineItem.PriceData.ProductData.builder().setName("CodeMitraYT Payment")
                                        .build()).build()
                        ).build()).build();
